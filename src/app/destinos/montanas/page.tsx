...
export default function MontanasPage() {
  const region = regions.find(r => r.id === 'montanas');
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <Breadcrumbs
            items={[
              ...
              { label: region.name, href: `/destinos/montanas` }
            ]}
          />
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-lg text-elephant-gray">
                Las montañas de Sri Lanka son un paraíso verde de plantaciones de té, 
                cascadas cristalinas y pueblos pintorescos. Un lugar donde el aire fresco 
                de la montaña se mezcla con el aroma del té recién cosechado y las vistas 
                panorámicas te dejan sin aliento.
              </p>
            ...
            >
              ...
              <p className="text-elephant-gray mb-6">
                Encuentra los mejores alojamientos en las montañas de Sri Lanka, 
                desde hoteles boutique con vistas al valle hasta acogedoras casas de té.
              </p>
              <a
