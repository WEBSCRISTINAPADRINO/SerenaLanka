...
export default function CiudadesHistoricasPage() {
  const region = regions.find(r => r.id === 'ciudades-historicas');
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <Breadcrumbs
            items={[
              ...
              { label: region.name, href: `/destinos/ciudades-historicas` }
            ]}
          />
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-lg text-elephant-gray">
                Explora las fascinantes ciudades históricas de Sri Lanka, donde cada calle 
                cuenta una historia y cada edificio es testigo de siglos de cultura y tradición. 
                Desde antiguas capitales hasta fortalezas coloniales, estas ciudades son un 
                tesoro de arquitectura y patrimonio.
              </p>
            ...
            >
              ...
              <p className="text-elephant-gray mb-6">
                Encuentra los mejores hoteles boutique y alojamientos históricos 
                en el corazón de las ciudades más emblemáticas de Sri Lanka.
              </p>
              <a
